...
mu_font :: #force_inline proc(font: int) -> mu.Font {
    return mu.Font(uintptr(FONT_SIZE))
}
...
demo_reel :: proc(ctx: ^mu.Context, render_force: ^bool, sim_speed: ^int, spheres: []Sphere) {
    @(static)
    opts := mu.Options{.NO_CLOSE, .ALIGN_CENTER, .NO_INTERACT, .NO_RESIZE}
